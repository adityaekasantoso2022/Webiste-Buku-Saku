                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="password">Password Default</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control w-100" id="password" name="password" placeholder="stematel123" disabled>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="form-check form-check-inline mt-1">
                                            <input class="form-check-input" type="radio" id="aktif" value="1" name="status">
                                            <label class="form-check-label" for="aktif">Aktif</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="tidak" value="0" name="status">
                                            <label class="form-check-label" for="tidak">Tidak Aktif</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="beku" value="2" name="status">
