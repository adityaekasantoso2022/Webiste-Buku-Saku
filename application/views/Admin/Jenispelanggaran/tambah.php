    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Tambah Jenis Pelanggaran</div>
            </div>
        </div>
                            ...
                            <form action="" method="POST">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control w-100" id="jenispelanggaran" name="jenispelanggaran" value="<?= set_value('jenispelanggar'); ?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <input type="number" name="points" id="points" class="form-control" value="<?= set_value('nama'); ?>">
