...
foreach ($siswa as $s) {
    $table .= '<tr>
                <td border="1">' . $i++ . '</td>
                <td border="1" align="left">' . $s['nis'] . '</td>
                <td border="1" align="left">' . $s['nama'] . '</td>
                <td border="1" align="left">' . $s['jenis_kelamin'] . '</td>
                <td border="1" align="left">' . $s['kelas'] . '</td>
                <td border="1" align="left">' . $s['email'] . '</td>
                <td border="1" align="center">' . $s['status'] . '</td>
                </tr>';
}
$table .= '</table>';
