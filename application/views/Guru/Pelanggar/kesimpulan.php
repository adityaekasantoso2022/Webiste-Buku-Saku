                                ...
                                <div class="row mx-auto justify-content-center">
                                    <div class="col-md-8">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="<?= base_url('Guru/Pelanggar/lapor/') . $isPelanggaran->jenis_pelanggaran_id . '/' . $isSiswa->siswa_id; ?>" class="btn btn-lg btn-block btn-primary btnLapor" id="btnLapor">Lapor Sekarang</a>
