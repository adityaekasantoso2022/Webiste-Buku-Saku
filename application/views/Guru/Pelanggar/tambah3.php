                                    ...
                                    <div class="col-lg-8">
                                        <form class="form-inline mr-auto">
                                            <div class="search-element">
                                                <input class="form-control" type="search" placeholder="Cari NIS, Nama Siswa..." id="keywordSiswa" autofocus>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <div class="text-center" id="resultSiswa" data-kasus="<?= $kasus ?>" data-kelas="<?= $kelas ?>">
