    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Pastikan anda mengikuti langkah demi langkah dalam melapor agar tidak terjadi kesalahan dikemudian hari
            </p>
        </div>
                        ...
                        <form class="wizard-content mt-1">
                            <div class="wizard-pane">
                                <div class="row text-center mb-3">
                                    <div class="col-lg-12">
                                        <h3 class="judul" id="judul">Pilih Jenis Pelanggaran</h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-8">
                                        <form class="form-inline mr-auto">
                                            <div class="search-element">
                                                <input class="form-control" type="search" id="keywordPelanggaran" placeholder="Cari Jenis Pelanggaran, Point Pelanggaran..." autofocus>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <div class="text-center" id="resultPelanggaran">
                                </div>
                            </div>
                        </form>
                    </div>
